            ...
            dbc.Row(
                [
                    ...
                    dbc.Col(
                        dbc.Card(
                            [
                                dbc.CardHeader(html.H6("The Weakest type is:")),
                                dbc.CardBody(
                    ...
                    dbc.Col(
                        dbc.Card(
                            [
                                dbc.CardHeader(html.H6("The Strongest type is:")),
                                dbc.CardBody(
                                    html.H4(
                ...
                [
                    ...
                    dbc.Col(
                        [
                            ...
                            html.Br(),
                            dcc.Graph(id="density_legendary", figure="fig"),
                            html.Br(),
                        ],
                        md=3,
                    ),
                    dbc.Col(
                        [
                            ...
                            html.Br(),
                            dcc.Graph(id="density_type", figure="fig"),
                            html.Br(),
                        ],
                        md=3,
                    ),
                    dbc.Col(
                        [
                            ...
                            html.Br(),
                            dcc.Graph(id="density_generation", figure="fig"),
                        ],
                        md=3,
                    ),
                ]
                        ...
                        [
                            dbc.Card(
                                [
                                    dbc.CardHeader(
                                        [
                                            html.H6("The type predicted for"),
                                            html.H6(id="p_name"),
                                        ]
                                    ),
                                    dbc.CardBody(
    ...
    [
        dbc.Row(
            [
                ...
                html.Img(
                    src=app.get_asset_url("bg-2.jpg"),
                    height=50,
                    style={
                        "margin-left": 20,
                        "margin-bottom": 20,
                ...
                dbc.Col(
                    [
                        ...
                        dbc.Badge(
                            "twitter",
                            href="https://twitter.com/nagarajbhat92",
                            color="secondary",
                            style={
                                "color": "white",
                                "margin-top": 5,
...
def strength_fig(strength, color_tab2, stat_type):
    ...
    fig.update_layout(
        title="Boxplot for different types of pokemon",
        uniformtext_minsize=15,
        uniformtext_mode="hide",
        transition_duration=500,
        height=600,
...
@app.callback(
    [
        Output("density_legendary", "figure"),
...
def heatmap_fig(color):
    ...
    # fig.update_traces(textfont_size=30)
    fig.update_layout(
        title="A pairplot showing relationship between different features of pokemon",
        uniformtext_minsize=15,
        uniformtext_mode="hide",
        transition_duration=500,
    )
...
def prediction_update(pokemon_name, features_checklist, pokemon_type):
    ...
    df_gd = df[df["Type 1"].isin(pokemon_type)]
    # Model prediction
    p_type, acc, fig, clf_report = type_prediction(
        pokemon_name, df_gd, features_checklist
    )
